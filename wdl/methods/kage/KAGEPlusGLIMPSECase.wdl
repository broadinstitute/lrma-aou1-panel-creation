...
workflow KAGEPlusGLIMPSECase {
    ...
    output {
        ...
        File glimpse_unphased_vcf_gz = GLIMPSECase.glimpse_unphased_vcf_gz
        File glimpse_unphased_vcf_gz_tbi = GLIMPSECase.glimpse_unphased_vcf_gz_tbi
        File glimpse_vcf_gz = GLIMPSECase.glimpse_vcf_gz
        File glimpse_vcf_gz_tbi = GLIMPSECase.glimpse_vcf_gz_tbi
    }
}
...
task GLIMPSECase {
    ...
    command {
        ...
        bcftools index ~{output_prefix}.concat.bcf
